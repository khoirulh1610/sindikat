<?php namespace App\Http\Controllers;
	...
	class AdminPriceController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->col = [];
			$this->col[] = ["label"=>"Paket","name"=>"paket_id","join"=>"packet,id"];
			...
			$this->form = [];
			$this->form[] = ['label'=>'Paket','name'=>'paket_id','type'=>'select2','validation'=>'required|integer|min:0','width'=>'col-sm-10','datatable'=>'packet,name_packet'];
			...
			# OLD START FORM
			//$this->form = [];
			//$this->form[] = ["label"=>"Paket Id","name"=>"paket_id","type"=>"select2","required"=>TRUE,"validation"=>"required|integer|min:0","datatable"=>"paket,id"];
