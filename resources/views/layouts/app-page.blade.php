...
<html lang="id"><head>
	...
	<meta name="description" content="{{$description ?? 'Jasa Pembuatan PT, PT PMA, PT Perorangan, Firma. Jasa Pendirian CV, Perkumpulan, Yayasan. Urus Izin Edar BPOM, Sertifikat Halal MUI, dll'}}">

	<!-- Facebook Meta Tags -->
	<meta property="og:url" content="https://sindikat.co.id">
	<meta property="og:type" content="website">
	<meta property="og:title" content="{{$description ?? 'Sindikat - Jasa Legalitas Terpercaya' }}">
	<meta property="og:description" content="{{$description ?? 'Jasa Pembuatan PT, PT PMA, PT Perorangan, Firma. Jasa Pendirian CV, Perkumpulan, Yayasan. Urus Izin Edar BPOM, Sertifikat Halal MUI, dll'}}">
	<meta property="og:image" content="{{$image->image ?? 'https://sindikat.co.id/assets/img/sindikat-jasa-legalitas-og.jpg'}}">

	<!-- Twitter Meta Tags -->
	<meta name="twitter:card" content="summary_large_image">
	<meta property="twitter:domain" content="sindikat.co.id">
	<meta property="twitter:url" content="https://sindikat.co.id">
	<meta name="twitter:title" content="{{$description ?? 'Sindikat - Jasa Legalitas Terpercaya' }}">
	<meta name="twitter:description" content="{{$description ?? 'Jasa Pembuatan PT, PT PMA, PT Perorangan, Firma. Jasa Pendirian CV, Perkumpulan, Yayasan. Urus Izin Edar BPOM, Sertifikat Halal MUI, dll'}}">
