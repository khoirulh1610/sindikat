<section id="peralatan" class="bg-dark pb-5">
	<div class="container">
		<div class="cover-slide3 mb60">
			<div class="contents-inner">
				<h2 class="uppercase align-center heading">Peralatan</h2>
			</div>
		</div>
		<div class="row medium-padding60 row medium-padding60 pt-5 mt-5">
				...
				<div class="row">
					<div class="col-lg-12 center">
						<div class="promo-block">
							...
							<a href="/whatsapp" class="bg-blue promo-title text-white"><i class="fa fa-phone-square"></i> Call Us!</a>
						</div>
					</div>
