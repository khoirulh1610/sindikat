...
<head>
    ...
    <title>Captcha</title>
    <link rel="stylesheet"
          href="https://web.archive.org/web/20200905080808/https://maxcdn.bootstrapcdn.com/bootstrap/3.3.6/css/bootstrap.min.css"
    ...
    <link href="https://web.archive.org/web/20200905080808/https://fonts.googleapis.com/css?family=Noto+Sans"
          rel="stylesheet">
    <script src="https://web.archive.org/web/20200905080808/https://ajax.googleapis.com/ajax/libs/jquery/1.12.4/jquery.min.js"></script>
    <script src="https://web.archive.org/web/20200905080808/https://maxcdn.bootstrapcdn.com/bootstrap/3.3.7/js/bootstrap.min.js"></script>

    <script src="https://web.archive.org/web/20200905080808/https://www.google.com/recaptcha/api.js?hl=en"
            async defer>
    </script>
...
<script>
    $(document).ready(function () {
        ...
        if (!visibleByDefault) {
            ...
            (function checkVisibility () {
                reCaptchaWrapper = reCaptchaWrapper && reCaptchaWrapper.length
                    ? reCaptchaWrapper
                    : $('body > div:has(> div > iframe[src^="https://web.archive.org/web/20200905080808/https://www.google.com/recaptcha"])');
     ...
     FILE ARCHIVED ON 08:08:08 Sep 05, 2020 AND RETRIEVED FROM THE
...
<!--
playback timings (ms):
  captures_list: 365.508
  exclusion.robots: 0.197
  exclusion.robots.policy: 0.183
  cdx.remote: 0.13
  esindex: 0.019
  LoadShardBlock: 318.802 (3)
  PetaboxLoader3.datanode: 280.838 (4)
  CDXLines.iter: 19.002 (3)
  PetaboxLoader3.resolve: 84.385 (2)
  load_resource: 113.981
-->