...
<head>
    ...
    <title>Captcha</title>
    <link rel="stylesheet"
          href="https://web.archive.org/web/20200905081132/https://maxcdn.bootstrapcdn.com/bootstrap/3.3.6/css/bootstrap.min.css"
    ...
    <link href="https://web.archive.org/web/20200905081132/https://fonts.googleapis.com/css?family=Noto+Sans"
          rel="stylesheet">
    <script src="https://web.archive.org/web/20200905081132/https://ajax.googleapis.com/ajax/libs/jquery/1.12.4/jquery.min.js"></script>
    <script src="https://web.archive.org/web/20200905081132/https://maxcdn.bootstrapcdn.com/bootstrap/3.3.7/js/bootstrap.min.js"></script>

    <script src="https://web.archive.org/web/20200905081132/https://www.google.com/recaptcha/api.js?hl=en"
            async defer>
    </script>
...
<script>
    $(document).ready(function () {
        ...
        if (!visibleByDefault) {
            ...
            (function checkVisibility () {
                reCaptchaWrapper = reCaptchaWrapper && reCaptchaWrapper.length
                    ? reCaptchaWrapper
                    : $('body > div:has(> div > iframe[src^="https://web.archive.org/web/20200905081132/https://www.google.com/recaptcha"])');
     ...
     FILE ARCHIVED ON 08:11:32 Sep 05, 2020 AND RETRIEVED FROM THE
...
<!--
playback timings (ms):
  captures_list: 62.724
  exclusion.robots: 0.091
  exclusion.robots.policy: 0.082
  RedisCDXSource: 0.57
  esindex: 0.009
  LoadShardBlock: 39.468 (3)
  PetaboxLoader3.datanode: 74.577 (4)
  CDXLines.iter: 20.042 (3)
  load_resource: 98.247
  PetaboxLoader3.resolve: 34.018
-->