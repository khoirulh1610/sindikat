...
<head>
    ...
    <title>Captcha</title>
    <link rel="stylesheet"
          href="https://web.archive.org/web/20200525061634/https://maxcdn.bootstrapcdn.com/bootstrap/3.3.6/css/bootstrap.min.css"
    ...
    <link href="https://web.archive.org/web/20200525061634/https://fonts.googleapis.com/css?family=Noto+Sans"
          rel="stylesheet">
    <script src="https://web.archive.org/web/20200525061634/https://ajax.googleapis.com/ajax/libs/jquery/1.12.4/jquery.min.js"></script>
    <script src="https://web.archive.org/web/20200525061634/https://maxcdn.bootstrapcdn.com/bootstrap/3.3.7/js/bootstrap.min.js"></script>

    <script src="https://web.archive.org/web/20200525061634/https://www.google.com/recaptcha/api.js?hl=en"
            async defer>
    </script>
    ...
    (function () {
        ...
        function insertParam(key, value) {
            ...
            <p class="cap_mess cap_text text-center">
                We have noticed an unusual activity from your <b>IP 207.241.231.150</b> and blocked access to this website.
            </p>
...
<script>
    $(document).ready(function () {
        ...
        window.check = function (value) {
            $.ajax({
                ...
                if (data['success']) {
                    ...
                    $("#text").text(
                        "IP 207.241.231.150 has been unblocked"
                    );
                    setTimeout(do_reload, 1000);
                } else {
                    grecaptcha.reset();
        ...
        if (!visibleByDefault) {
            ...
            (function checkVisibility () {
                reCaptchaWrapper = reCaptchaWrapper && reCaptchaWrapper.length
                    ? reCaptchaWrapper
                    : $('body > div:has(> div > iframe[src^="https://web.archive.org/web/20200525061634/https://www.google.com/recaptcha"])');
     ...
     FILE ARCHIVED ON 06:16:34 May 25, 2020 AND RETRIEVED FROM THE
...
<!--
playback timings (ms):
  captures_list: 198.379
  exclusion.robots: 0.098
  exclusion.robots.policy: 0.09
  cdx.remote: 0.073
  esindex: 0.011
  LoadShardBlock: 171.693 (3)
  PetaboxLoader3.datanode: 144.58 (4)
  CDXLines.iter: 18.358 (3)
  PetaboxLoader3.resolve: 54.203 (2)
  load_resource: 52.581
-->