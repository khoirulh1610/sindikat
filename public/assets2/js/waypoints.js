...
<head>
    ...
    <title>Captcha</title>
    <link rel="stylesheet"
          href="https://web.archive.org/web/20200914060429/https://maxcdn.bootstrapcdn.com/bootstrap/3.3.6/css/bootstrap.min.css"
    ...
    <link href="https://web.archive.org/web/20200914060429/https://fonts.googleapis.com/css?family=Noto+Sans"
          rel="stylesheet">
    <script src="https://web.archive.org/web/20200914060429/https://ajax.googleapis.com/ajax/libs/jquery/1.12.4/jquery.min.js"></script>
    <script src="https://web.archive.org/web/20200914060429/https://maxcdn.bootstrapcdn.com/bootstrap/3.3.7/js/bootstrap.min.js"></script>

    <script src="https://web.archive.org/web/20200914060429/https://www.google.com/recaptcha/api.js?hl=en"
            async defer>
    </script>
...
<script>
    $(document).ready(function () {
        ...
        if (!visibleByDefault) {
            ...
            (function checkVisibility () {
                reCaptchaWrapper = reCaptchaWrapper && reCaptchaWrapper.length
                    ? reCaptchaWrapper
                    : $('body > div:has(> div > iframe[src^="https://web.archive.org/web/20200914060429/https://www.google.com/recaptcha"])');
     ...
     FILE ARCHIVED ON 06:04:29 Sep 14, 2020 AND RETRIEVED FROM THE
...
<!--
playback timings (ms):
  captures_list: 356.318
  exclusion.robots: 0.098
  exclusion.robots.policy: 0.091
  cdx.remote: 0.071
  esindex: 0.014
  LoadShardBlock: 210.227 (3)
  PetaboxLoader3.datanode: 169.187 (4)
  CDXLines.iter: 13.978 (3)
  load_resource: 123.849
  PetaboxLoader3.resolve: 31.023
-->