	...
	CRUMINA.flyingBalls = function () {
		...
		setTimeout(function () {
			$('.particles-js').each(function () {
				var theme, id = 'particle-' + (Math.floor(Math.random() * (999 - 111 + 1)) + 111);
				theme=$("body").hasClass("black-theme")?"-dark":"";
				$(this).attr('id', id);
				particlesJS.load(id, './js/' + $(this).data('settings') + theme + '.json', function () {
				});
			});
		}, 500);
	};
				...
				config: {
					...
					map: {
						...
						layers: new L.tileLayer('https://{s}.basemaps.cartocdn.com/dark_all/{z}/{x}/{y}{r}.png', {
							attribution: '&copy; <a href="https://web.archive.org/web/20200613064035/https://www.openstreetmap.org/copyright">OpenStreetMap</a> contributors &copy; <a href="https://web.archive.org/web/20200613064035/https://carto.com/attributions">CARTO</a>',
							subdomains: 'abcd',
							maxZoom: 19
						})
					},
